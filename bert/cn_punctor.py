...
import modeling,optimization,tokenization,tf_metrics
...
## Required parameters
flags.DEFINE_string(
    "data_dir", '../data/dataset/lrec/',
    "The input data dir. Should contain the json files (or other data files) "
    "for the task.")
flags.DEFINE_string('data_config_path', '../data/outputdata_pd.conf',
                    'data config file, which save train and dev config')
flags.DEFINE_string(
    "test_data_dir", '../data/raw/LREC_converted/',
    "The input data dir. Should contain the .txt files (or other data files) "
    "for the task.")

flags.DEFINE_string(
    "bert_config_file", '/home/eric/data/chinese_L-12_H-768_A-12/bert_config.json',
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name",'Punctor' , "The name of the task to train.")

flags.DEFINE_string("vocab_file", '/home/eric/data/chinese_L-12_H-768_A-12/vocab.txt',
...
''
flags.DEFINE_string(
    "init_checkpoint", '/home/eric/data/chinese_L-12_H-768_A-12/bert_model.ckpt',
...
class PunctorProcessor(DataProcessor):
    ...
    def get_test_examples(self,data_dir):
        ...
        input_file ='../data/raw/LREC/2014_test.txt'
        index = 0
        lines = []
